...
from Tkinter import Label, Entry, Button, Radiobutton, LabelFrame, StringVar, IntVar, END, DISABLED, NORMAL
...
class KeithleySM():
    ...
    def __init__(self, parent):
        ...
        # figCanv.get_tk_widget().grid(column=0, row=0, rowspan=13, sticky='W')
