...
class VPulse_LI():
    ...
    def start_li_pulse(self):
        ...
        currentData = list()  # To be plotted on x-axis
        lightData = list()  # To be plotted on y-axis
...
class VPulse_IV():
    ...
    def __init__(self, parent):
        ...
        self.volt_imp_label = Label(self.instrFrame, text='Impedance')
        self.volt_imp_label.grid(column=1, row=6, sticky='W')
        ...
        self.volt_impedance_dropdown = OptionMenu(self.instrFrame, self.volt_channel_impedance, *volt_impedance)
        self.volt_impedance_dropdown.grid(column=1, row=7, padx=5,pady=(0,5), sticky='W')
